...
class ImsTTS:
    ...
    def __init__(self, hifigan_path, fastspeech_path, device, embedding_path=None, output_sr=16000, lang='eng'):
        self.device = device
    ...
    def read_text(self, text, speaker_embedding, text_is_phones=True, language='eng', duration=None, pitch=None,
        ...
        #     print(sr, wav.shape[0], pitch.shape, energy.shape, duration.sum())
        #     if i > 0 and i % 10 == 0:
